...
const translations = {
  fr: {
    ...
    copyright: "© 2026 KORAL Parfum Collection. Tous droits réservés.",
    filterMen: "Homme",
    filterWomen: "Femme",
    ...
    orderSuccessMsg: "Merci d'avoir choisi KORAL. Votre commande est reçue et en cours de traitement.",
    ...
    aboutUsText: "KORAL Parfum Collection propose des eaux de parfum d'inspiration haut de gamme, sélectionnées avec soin pour leur tenue, leur sillage et leur raffinement. Notre mission est de rendre le luxe olfactif accessible, avec un service rapide et attentionné partout au Maroc.",
    ...
    trackingLookupPh: "ex. KORAL-XXXXXXX",
...
function genOrderNumber(){
  return 'KORAL-' + Date.now().toString(36).toUpperCase().slice(-6) + Math.random().toString(36).slice(2, 4).toUpperCase();
}
          ...
          ${b.type === 'video'
            ...
            : (() => {
                ...
                if(isPriorityEligible && !isGifBanner){
                  return `<img src="${b.url}" alt="KORAL" loading="eager" fetchpriority="high">`;
                }
                return `<img class="seq-lazy" data-src="${b.url}" alt="KORAL">`;
              })()}
        </div>`;
    ...
    <div class="ad-order-detail">
      <div class="ad-order-detail-inner">
        ...
        <div class="ad-quick-actions">
          ...
          <a class="ad-qa-btn ad-qa-btn-wa" target="_blank" rel="noopener" href="https://wa.me/${waPhone}?text=${encodeURIComponent('Bonjour ' + o.customer_name + ', concernant votre commande ' + o.order_number + ' chez KORAL...')}"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.1c-5.5 0-10 4.5-10 10 0 1.8.5 3.5 1.3 5L2 22l5.1-1.3c1.4.8 3.1 1.2 4.9 1.2 5.5 0 10-4.5 10-10s-4.5-9.8-10-9.8z"/></svg>WhatsApp</a>
  ...
  area.innerHTML = `
    <div style="max-width:700px;margin:40px auto;font-family:'Jost',sans-serif;color:#16181d;padding:30px;">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;border-bottom:2px solid #16181d;padding-bottom:18px;margin-bottom:24px;">
        <div>
          <div style="font-family:'Jost',sans-serif;font-weight:700;font-size:22px;letter-spacing:.08em;">KORAL</div>
      ...
      <div style="margin-top:40px;font-size:11px;color:#9ca3af;text-align:center;">Merci pour votre confiance — KORAL Parfum Collection</div>
    </div>`;
  window.print();
  ...
  return `
    <div class="ad-label-box" id="ad-label-${uid}">
      <div class="ad-label-head">
        <div class="ad-label-brand">KORAL<small>Parfum Collection</small></div>
